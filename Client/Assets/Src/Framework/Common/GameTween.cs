...
public static class GameTween
{
    ...
    public static XTween DOShakePosition(object obj, float duration, float strength, int vibrato, float randomness, bool fadeOut)
    {
        if (obj is Transform) return new XTween((obj as Transform).DOShakePosition(duration, strength, vibrato, randomness, fadeOut));
        return null;
    }
    ...
    public static XTween DOShakeRotation(object obj, float duration, float strength, int vibrato, float randomness, bool fadeOut)
    {
        if (obj is Transform) return new XTween((obj as Transform).DOShakeRotation(duration, strength, vibrato, randomness, fadeOut));
        return null;
    }
    public static XTween DOShakeScale(object obj, float duration, Vector3 strength, int vibrato, float randomness, bool fadeOut)
    {
        if (obj is Transform) return new XTween((obj as Transform).DOShakeScale(duration, strength, vibrato, randomness, fadeOut));
        return null;
    }
    public static XTween DOShakeScale(object obj, float duration, float strength, int vibrato, float randomness, bool fadeOut)
    {
        if (obj is Transform) return new XTween((obj as Transform).DOShakeScale(duration, strength, vibrato, randomness, fadeOut));
        return null;
    }
