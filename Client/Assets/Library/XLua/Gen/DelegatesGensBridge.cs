...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp15(bool p0, Framework.UnityAsset.AsyncAsset p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp17(UnityEngine.GameObject p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(int p0, UnityEngine.GameObject p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp19(int p0, string p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp23(object p0, object p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp24(object p0, SDKManager.LoginType p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Action<string> __Gen_Delegate_Imp25(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                System.Action<string> __gen_ret = translator.GetDelegate<System.Action<string>>(L, errFunc + 1);
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<bool, Framework.UnityAsset.AsyncAsset>))
			{
			    return new System.Action<bool, Framework.UnityAsset.AsyncAsset>(__Gen_Delegate_Imp15);
			}
			...
			{
			    return new System.Action<UnityEngine.GameObject>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Action<int, UnityEngine.GameObject>))
			{
			    return new System.Action<int, UnityEngine.GameObject>(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(System.Action<int, string>))
			{
			    return new System.Action<int, string>(__Gen_Delegate_Imp19);
			}
