...
namespace XLua.CSObjectWrap
{
    ...
    public class ScrollPoolHorizontalWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ScrollPoolHorizontal);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ScrollPoolHorizontal();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ScrollPoolHorizontal constructor!");
        ...
        static int _m_SetListPivot(RealStatePtr L)
        {
		    try {
                ...
                ScrollPoolHorizontal gen_to_be_invoked = (ScrollPoolHorizontal)translator.FastGetCSObj(L, 1);
