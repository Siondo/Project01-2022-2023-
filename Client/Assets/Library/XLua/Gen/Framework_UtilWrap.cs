...
namespace XLua.CSObjectWrap
{
    ...
    public class FrameworkUtilWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Framework.Util);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SimpleEncrypt", _m_SimpleEncrypt_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SimpleDecrypt", _m_SimpleDecrypt_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetTextMD5", _m_GetTextMD5_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "Get32Random", _m_Get32Random_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetStringBuilder", _m_GetStringBuilder_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "Now", _m_Now_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "DateNow", _m_DateNow_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Framework.Util();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Framework.Util constructor!");
        ...
        static int _m_GetPlatform_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = Framework.Util.GetPlatform(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SimpleEncrypt_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 1);
                        ...
                        var gen_ret = Framework.Util.SimpleEncrypt( _bytes );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _encrypt = LuaAPI.lua_tostring(L, 1);
                    
                        var gen_ret = Framework.Util.SimpleEncrypt( _encrypt );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Framework.Util.SimpleEncrypt!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SimpleDecrypt_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 1);
                        ...
                        var gen_ret = Framework.Util.SimpleDecrypt( _bytes );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _encrypt = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = Framework.Util.SimpleDecrypt( _encrypt );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Framework.Util.SimpleDecrypt!");
        ...
        static int _m_WriteAllBytes_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Framework.Util.WriteAllBytes( _path, _bytes );
        ...
        static int _m_WriteAllText_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Framework.Util.WriteAllText( _path, _text );
        ...
        static int _m_GetMD5_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 1);
                        ...
                        var gen_ret = Framework.Util.GetMD5( _bytes );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _file = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = Framework.Util.GetMD5( _file );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Framework.Util.GetMD5!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetTextMD5_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _txt = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = Framework.Util.GetTextMD5( _txt );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _defaultValue = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = Framework.Util.GetString( _key, _defaultValue );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _defaultValue = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = Framework.Util.GetInt( _key, _defaultValue );
		    ...
		    try {
                ...
                
                {
                    ...
                    float _defaultValue = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = Framework.Util.GetFloat( _key, _defaultValue );
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _defaultValue = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = Framework.Util.GetBool( _key, _defaultValue );
        ...
        static int _m_SetString_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Framework.Util.SetString( _key, _value );
        ...
        static int _m_SetInt_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Framework.Util.SetInt( _key, _value );
        ...
        static int _m_SetFloat_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Framework.Util.SetFloat( _key, _value );
        ...
        static int _m_SetBool_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Framework.Util.SetBool( _key, _value );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Get32Random_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = Framework.Util.Get32Random(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetStringBuilder_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string[] _args = translator.GetParams<string>(L, 1);
                    
                        var gen_ret = Framework.Util.GetStringBuilder( _args );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _m_Now_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = Framework.Util.Now(  );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DateNow_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = Framework.Util.DateNow(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetDeviceUniqueIdentifier_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = Framework.Util.GetDeviceUniqueIdentifier(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
