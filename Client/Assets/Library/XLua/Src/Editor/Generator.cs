...
#else
        public static string common_path = Application.dataPath + "/Library/XLua/Gen/";
#endif
...
#pragma warning restore 618
        ...
        public static void GenAll()
        {
            ...
            if (File.Exists("./Tools/XLua/MonoBleedingEdge/bin/mono.exe"))
            {
                GenUsingCLI();
                return;
            }
            ...
            // 复制代码
            AssetDatabase.CopyAsset("Assets/Library/XLua/link.lib", "Assets/Library/XLua/Gen/UnityEngine_LightWrap.cs");
            AssetDatabase.Refresh();
        }
        ...
        {
#if UNITY_EDITOR_OSX
            var monoPath = "./Tools/XLua/MonoBleedingEdge/bin/mono";
#else
            var monoPath = "./Tools/XLua/MonoBleedingEdge/bin/mono.exe";
#endif

            var args = new List<string>()
            {
                "./Tools/XLua/XLuaGenerate.exe",
