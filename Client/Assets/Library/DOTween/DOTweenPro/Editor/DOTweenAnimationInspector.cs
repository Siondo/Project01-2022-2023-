...
#pragma warning restore 414
        ...
        void Awake()
        {
            ...
            if( _src.GetComponent<DOTweenVisualManager>() == null )
                _src.gameObject.AddComponent<DOTweenVisualManager>().onEnableBehaviour = OnEnableBehaviour.Restart;
        }
